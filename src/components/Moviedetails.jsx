  ...
  return info ? (
    <div  style={{
     ...
     <Link onClick={()=>navigate(-1)} 
      ...
      <img className='shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] h-[43vh] object-cover   ' 
      src={`https://image.tmdb.org/t/p/original/${  info.detail.poster_path || info.detail.backdrop_path }`} alt="" />
       ...
       <div className='content ml-[5%] text-white'>
        <h1 className='text-5xl font-black  '>
          ...
          <h1 className='text-2xl mt-5 mb-3'>Movie Translated in:</h1>
      ...
      <div className='w-[80%]  flex flex-col  absolute left-[5%] top-[40%] gap-y-5'>
